...
//	    System.out.println("PUT CLEAR, 1");
	    root = dictionary.getRoot();
//	    System.out.println("ROOT FOUND, CHECK");
...
//		System.out.println("Clear for put");
		...
		if (passed) System.out.println("Test 4 passed");
...
//			System.out.print("Wrong Root.");
	...
	try {
	    ...
	    if ((data.getName()).compareTo(keys[3]) != 0) {
	    	passed = false;
	    	System.out.println("You succ lmao.");
	    }
	    data = dictionary.smallest(root);
	    if ((data.getName()).compareTo(keys[2]) != 0) {
	    	passed = false;
//	    	System.out.println("Baby dende having loser.");
	    }
	...
	//Test the predecessor and largest methods
	if (alltests || test == 8)
	try {
	    passed = true;
//	    System.out.println("Looking back for ya fool.");
	    data = dictionary.predecessor(root,keys[0]);
	    System.out.println(data.getName());
	    if ((data.getName()).compareTo(keys[4]) != 0) {
	    	passed = false;
	    	System.out.println("prehistoric failure");
	    }
	    data = dictionary.largest(root);
	    if ((data.getName()).compareTo(keys[0]) != 0) {
	    	passed = false;
	    	System.out.println("phatty");
	    }
